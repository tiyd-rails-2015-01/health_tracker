...
class CaloriesControllerTest < ActionController::TestCase
  ...
  test "should create calory" do
    assert_difference('Calory.count') do
      post :create, calory: { calories_consumed: @calory.calories_consumed, calories_on: @calory.calories_on }
    end
  ...
  test "should update calory" do
    patch :update, id: @calory, calory: { calories_consumed: @calory.calories_consumed, calories_on: @calory.calories_on }
    assert_redirected_to calory_path(assigns(:calory))
  end
