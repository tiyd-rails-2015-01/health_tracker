...
class CalorieConsumptionsControllerTest < ActionController::TestCase
  ...
  test "should create calorie_consumption" do
    assert_difference('CalorieConsumption.count') do
      post :create, calorie_consumption: { calorie_intake: @calorie_consumption.calorie_intake, consumed_on: @calorie_consumption.consumed_on, food: @calorie_consumption.food }
    end
  ...
  test "should update calorie_consumption" do
    patch :update, id: @calorie_consumption, calorie_consumption: { calorie_intake: @calorie_consumption.calorie_intake, consumed_on: @calorie_consumption.consumed_on, food: @calorie_consumption.food }
    assert_redirected_to calorie_consumption_path(assigns(:calorie_consumption))
  end
